        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            ...
            <p className="text-xs mt-2 opacity-75">
              ...
              <a href="https://policies.google.com/privacy" target='_blank' className="text-primary-light underline hover:text-gray-300 ml-1">Privacy Policy</a> and
              <a href="https://policies.google.com/terms" target='_blank' className="text-primary-light underline hover:text-gray-300 ml-1">Terms of Service</a> apply.
            </p>
          </div>
